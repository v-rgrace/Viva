...
| [![Screenshot of the shifts card icon with a link to more information.](../media/connections/shifts-card-icon.png)](available-dashboard-cards.md#add-the-shifts-card) | Display information about the next or current shift from the Shifts app in Teams. |
...
| [![Screenshot of the Teams app icon with a link to more information.](../media/connections/teams-app-icon.png)](available-dashboard-cards.md#add-the-teams-app-card) |   Use to open a Teams personal app or bot specified by the dashboard author. |

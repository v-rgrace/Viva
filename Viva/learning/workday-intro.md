...
|---|---|
| Catalog types  | Viva Learning supports all catalog types from Workday. These types include:<br><ul><li>Digital courses</li><li>Blended courses</li><li>Programs (equivalent to learning paths in Viva Learning)</li><li>Lessons</li></ul> In addition to this Viva Learning supports ingestion of content from other learning providers configured in Workday, such as LinkedIn Learning configured in Workday.  | 
